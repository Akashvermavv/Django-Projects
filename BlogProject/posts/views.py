...
def post_detail(request,slug=None):
    ...
    if form.is_valid() and request.user.is_authenticated:
        # print('comment form--',comment_form.cleaned_data)
...
def post_list(request):
    print('post list user is ',request.user,' ### ',request.user.username)
    ...
    context = {
               ...
               'title':'List',
                'today':today,
        # 'demo_list':['p1','p2','p3','p4','p5','p6','p7','p8']
               }
...
def post_update(request,slug=None):
    ...
    return render(request,"posts/post_form.html",context)
    # return HttpResponse('<h1>hello post_update view</h1>')
...
def post_delete(request,id=None):
    ...
    return redirect("posts:posts_list_view")
